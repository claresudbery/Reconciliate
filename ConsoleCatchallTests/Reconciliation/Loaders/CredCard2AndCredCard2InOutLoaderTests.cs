...
namespace ConsoleCatchallTests.Reconciliation.Loaders
{
    ...
    public class CredCard2AndCredCard2InOutLoaderTests
    {
        ...
        public void Load__Will_create_a_reconciliation_interface_using_file_details_from_loading_info()
        {
            ...
            // Assert 
            var third_party_file_io = ((CredCard2Reconciliator)reconciliation_interface.Reconciliator).Third_party_file.File_io;
            Assert.AreEqual(loading_info.File_paths.Third_party_file_name, third_party_file_io.File_name);
            var owned_file_io = ((CredCard2Reconciliator)reconciliation_interface.Reconciliator).Owned_file.File_io;
