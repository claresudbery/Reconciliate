...
namespace ConsoleCatchallTests.Reconciliation.Loaders
{
    ...
    public class CredCard2AndCredCard2InOutLoaderTests
    {
        ...
        public void CredCard2_and_credCard2_in_out__Merge_bespoke_data_with_pending_file__Will_add_most_recent_CredCard2_direct_debits()
        {
            ...
            FileLoaderTests.Assert_pending_record_is_given_the_specified_direct_debit_details(pending_records[0], next_direct_debit_date01, expected_amount1, ReconConsts.Cred_card2_regular_pymt_description);
            FileLoaderTests.Assert_pending_record_is_given_the_specified_direct_debit_details(pending_records[1], next_direct_debit_date02, expected_amount2, ReconConsts.Cred_card2_regular_pymt_description);
        }
