...
namespace ConsoleCatchallTests.Reconciliation.Loaders
{
    ...
    public class CredCard1AndCredCard1InOutDataTests
    {
        ...
        public void M_MergeBespokeDataWithPendingFile_WillAddMostRecentCredCard1DirectDebits()
        {
            ...
            AssertDirectDebitDetailsAreCorrect(pending_records[0], next_direct_debit_date01, expected_amount1, ReconConsts.CredCard1RegularPymtDescription);
            AssertDirectDebitDetailsAreCorrect(pending_records[1], next_direct_debit_date02, expected_amount2, ReconConsts.CredCard1RegularPymtDescription);
        }
