namespace Interfaces.Constants
{
    public static class ReconConsts
    {
        ...
        public const string CantFindPreviousBudgetRow = "Can't find '{0}' row (used for calculating next unplanned month, for budget out). \nCheck you don't have the spreadsheet open! \nAlso check Budget Out / Budget In has transaction description that matches the previous month. \nIf you've just changed it, it will be fine next time. \nFor now, please enter number for the first month you would like to schedule budgeted amounts:";
        ...
        public const string LastOnlineTransaction = "!! Last online transaction!!";
