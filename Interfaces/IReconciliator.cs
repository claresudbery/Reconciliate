...
namespace Interfaces
{
    public interface IReconciliator
    {
        ...
        void Match_current_record(int matchIndex);
        ...
        void Delete_specific_third_party_record(int specifiedIndex);
        void Delete_specific_owned_record_from_list_of_matches(int specifiedIndex);
        ...
        void Remove_auto_match(int matchIndex);
        void Remove_multiple_auto_matches(List<int> matchIndices);
        void Remove_final_match(int matchIndex);
        void Remove_multiple_final_matches(List<int> matchIndices);
        void Refresh_files();
    }
}