...
namespace ReconciliationBaseTests.ReconciliationBase
{
    ...
    internal partial class ReconciliationInterfaceTests : IInputOutput
    {
        ...
        public void M_CanShowMatchesWithoutImpactingOnThoseMatches()
        {
            ...
            var previous_matches = reconciliator.CurrentPotentialMatches();
            var num_previous_matches = previous_matches.Count;
            var previous_first_match_description = previous_matches[0].ActualRecords[0].Description;
            var previous_last_match_description = previous_matches[num_previous_matches - 1].ActualRecords[0].Description;

            // Act
            reconciliation_interface.ShowCurrentRecordAndSemiAutoMatches();

            // Assert
            var current_matches = reconciliator.CurrentPotentialMatches();
            Assert.AreEqual(num_previous_matches, current_matches.Count);
            Assert.AreEqual(previous_first_match_description, current_matches[0].ActualRecords[0].Description);
            Assert.AreEqual(previous_last_match_description, current_matches[num_previous_matches - 1].ActualRecords[0].Description);
        }
        ...
        public void M_WhenMatchingIsDone_AllRecordsAreProcessed()
        {
            ...
            for (int actual_bank_count = 0; actual_bank_count < actual_bank_lines.Count; actual_bank_count++)
            {
                ...
                VerifyIsOutputAsConsoleLine(actual_bank_lines[actual_bank_count].Description, numTimes:1);
                ...
                VerifyIsOutputAsConsoleSnippet(bank_lines[first_of_each_bank_pair].Description, numTimes: 1);
                ...
                VerifyIsOutputAmongstNonPrioritisedMatches(bank_lines[second_of_each_bank_pair].Description, numTimes: 1);
            }
        }
        ...
        public void M_WhenMatchingIsDoneForNonMatchingRecords_AllRecordsAreProcessed()
        {
            ...
            reconciliation_interface.DoMatchingForNonMatchingRecords();
            ...
            {
                VerifyIsOutputAmongstAllMatches($"{MatchDescription}0{bank_count + 1}b", numTimes: bank_count + 1);
            }
        ...
        public void M_WhenCurrentThirdPartyRecordIsDeleted_ShouldTryToMatchNextRecord(bool autoMatching)
        {
            ...
            var reconciliator = new BankReconciliator(_mockActualBankFileIO.Object, _mockBankFileIO.Object, BankAndBankInData.LoadingInfo);
            SetupToDeleteThirdPartyRecord(actual_bank_records[0].Description);
            SetupToChooseMatch(actual_bank_records[1].Description, 0);
            SetupToExitAtTheEnd();
            var reconciliation_interface = new ReconciliationInterface(_mockInputOutput.Object, reconciliator, "ActualBank", "Bank In");
            var previous_num_third_party_records = reconciliator.NumThirdPartyRecords();
            ...
            // Assert
            Assert.AreEqual(previous_num_third_party_records - 1, reconciliator.NumThirdPartyRecords());
            Assert.AreEqual(actual_bank_records[1].Description, reconciliator.CurrentSourceDescription());
        }
        ...
        public void M_WhenOwnedRecordIsDeletedAfterAutoMatching_ShouldUpdateListOfMatches()
        {
            ...
            SetupToDeleteOwnedRecordOnceOnly(actual_bank_records[0].Description, index_of_deleted_record, 0);
            SetupToExitAtTheEnd();
            var description_of_deleted_record = bank_records[2].Description;
            PrepareToVerifyRecordIsOutputAmongstNonPrioritisedMatches(description_of_deleted_record);
            var reconciliation_interface = new ReconciliationInterface(_mockInputOutput.Object, reconciliator, "ActualBank", "Bank In");
            ...
            VerifyIsOutputAsConsoleSnippet(bank_records[1].Description, numTimes: 2);
            VerifyIsOutputAmongstNonPrioritisedMatches(bank_records[3].Description, numTimes: 2);
        ...
        public void M_WhenOwnedRecordIsDeletedAfterManualMatching_ShouldUpdateListOfMatches()
        {
            ...
            PrepareToVerifyRecordIsOutputAmongstAllMatches(description_of_deleted_record);
            var reconciliation_interface = new ReconciliationInterface(_mockInputOutput.Object, reconciliator, "ActualBank", "Bank In");
            ...
            // Assert
            // The records that aren't deleted should get output twice.
            VerifyIsOutputAmongstAllMatches(description_of_matched_record, numTimes: 2);
            VerifyIsOutputAmongstAllMatches(bank_records[1].Description, numTimes: 2);
            VerifyIsOutputAmongstAllMatches(bank_records[3].Description, numTimes: 2);
            // The record that's deleted should only get output once.
            _mockInputOutput.Verify();
            Assert.AreEqual(1, _numTimesCalled);
        }
        ...
        public void M_WhenOwnedRecordDeletionResultsInAnError_ThenUserNotified_AndAskedForNewInput(bool autoMatching)
        {
            ...
            SetupToDeleteOwnedRecordOnceOnly(actual_bank_records[0].Description, index_too_high, 0);
            SetupToExitAtTheEnd();
            var reconciliation_interface = new ReconciliationInterface(_mockInputOutput.Object, reconciliator, "ActualBank", "Bank In");
            ...
            _mockInputOutput.Verify(x =>
                ...
                Times.Once);
            _mockInputOutput.Verify(x =>
                    x.GetInput(ReconConsts.EnterNumberOfMatch, actual_bank_records[0].Description),
                Times.Exactly(2));
        }
        ...
        public void M_WhenOwnedRecordIsDeletedAfterAutoMatching_IfNoMatchesAreLeft_ShouldShowMessage_AndMoveOnToNextThirdPartyRecord()
        {
            ...
            _mockInputOutput.Verify(x =>
                ...
                Times.Once);
            _mockInputOutput.Verify(x =>
                    x.GetInput(ReconConsts.EnterNumberOfMatch, actual_bank_records[1].Description),
                Times.Once);
        }
        ...
        public void M_DespiteAMixtureOfDeletionsAfterAutoMatching_AllRecordsShouldBeOutputToUser()
        {
            ...
            var index_of_deleted_record = 0;
            SetupToDeleteOwnedRecordOnceOnly(actual_bank_records[0].Description, index_of_deleted_record, 0);
            SetupToDeleteOwnedRecordTwiceOnly(actual_bank_records[1].Description, index_of_deleted_record, 0);
            SetupToDeleteThirdPartyRecord(actual_bank_records[2].Description);
            _mockInputOutput.Setup(x => x.GetInput(ReconConsts.EnterNumberOfMatch, 
                    actual_bank_records[3].Description))
                .Returns("0");
            SetupToDeleteThirdPartyRecord(actual_bank_records[4].Description);
            _mockInputOutput.Setup(x => x.GetInput(ReconConsts.EnterNumberOfMatch,
                    actual_bank_records[5].Description))
                .Returns("0");
            SetupToDeleteOwnedRecordOnceOnly(actual_bank_records[6].Description, index_of_deleted_record, 0);
            SetupToExitAtTheEnd();
            var reconciliation_interface = new ReconciliationInterface(_mockInputOutput.Object, reconciliator, "ActualBank", "Bank In");
            ...
            {
                VerifyIsOutputAsConsoleLine(actual_bank_record_descriptions[actual_bank_records.IndexOf(actual_bank_record)], -1);
            }
        ...
        public void M_AfterAMixtureOfDeletionsDuringAutoMatching_TheNumberOfRecordsFinallyReconciledShouldBeCorrect()
        {
            ...
            Assert.AreEqual(bank_records.Count - 3, reconciliator.NumOwnedRecords(), "NumOwnedRecords");
            Assert.AreEqual(actual_bank_records.Count - 2, reconciliator.NumThirdPartyRecords(), "NumThirdPartyRecords");
        }
        ...
        public void M_AfterAMixtureOfDeletionsDuringManualMatching_TheNumberOfRecordsFinallyReconciledShouldBeCorrect()
        {
            ...
            // Assert
            Assert.AreEqual(bank_records.Count - 4, reconciliator.NumOwnedRecords(), "NumOwnedRecords");
            Assert.AreEqual(actual_bank_records.Count - 2, reconciliator.NumThirdPartyRecords(), "NumThirdPartyRecords");
        }
        ...
        public void M_WhenSemiAutoMatchHasDifferentAmount_WillAddExplanatoryTextAndChangeAmount()
        {
            ...
            _mockActualBankFileIO.Setup(x => x.Load(It.IsAny<List<string>>(), null))
                .Returns(actual_bank_records);
            var bank_records = new List<BankRecord>{
                new BankRecord {UnreconciledAmount = AmountForMatching + 1, Description = common_description}};
            _mockBankFileIO.Setup(x => x.Load(It.IsAny<List<string>>(), null))
                .Returns(bank_records);
            var reconciliator = new BankReconciliator(_mockActualBankFileIO.Object, _mockBankFileIO.Object, BankAndBankInData.LoadingInfo);
            SetupForAllMatchesChosenWithIndexZero();
            ...
            Assert.AreEqual(actual_bank_records[0].MainAmount(), bank_records[0].ReconciledAmount);
        }
        ...
        public void M_IfUserPressesEnter_WhenAskedWhichRecordToDelete_NoErrorShouldOccur()
        {
            ...
            _mockInputOutput.SetupSequence(x =>
                ...
                .Returns("");
            _mockInputOutput.Setup(x =>
                    x.GetInput(ReconConsts.WhetherToDeleteThirdParty, actual_bank_records[0].Description))
                .Returns("N");
            var reconciliator = new BankReconciliator(_mockActualBankFileIO.Object, _mockBankFileIO.Object, BankAndBankInData.LoadingInfo);
            var reconciliation_interface = new ReconciliationInterface(_mockInputOutput.Object, reconciliator, "ActualBank", "Bank In");
        ...
        public void M_WhenRecursivelyHandlingAutoMatches_IfMatchesAreRemoved_CorrectResultsAreShown()
        {
            ...
            // Assert
            var text1_lines = _outputAllLinesRecordedConsoleLines.Where(x => x.DescriptionString == text1);
            var text2_lines = _outputAllLinesRecordedConsoleLines.Where(x => x.DescriptionString == text2);
        ...
        public void M_WhenRecursivelyHandlingFinalMatches_IfMatchesAreRemoved_CorrectResultsAreShown()
        {
            ...
            // Assert
            var text1_lines = _outputAllLinesRecordedConsoleLines.Where(x => x.DescriptionString.Contains(text1));
            var text2_lines = _outputAllLinesRecordedConsoleLines.Where(x => x.DescriptionString.Contains(text2));
        ...
        public void M_WhenChoosingMatch_IfBadIndexEntered_ThenErrorShownAndUserAskedAgain(TransactionMatchType transactionMatchType)
        {
            ...
            Assert.IsTrue(_outputSingleLineRecordedMessages.Contains(Reconciliator<ActualBankRecord, BankRecord>.BadMatchNumber),
                "Bad match error message should be shown");
            var text1_lines = _outputSingleLineRecordedConsoleLines.Where(x => x.DescriptionString == text1);
